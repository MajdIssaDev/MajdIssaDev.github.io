export const site = {
  name: 'Majd Issa',
  title: 'Computer Science · Real-Time Graphics',
  tagline:
    'I am a Computer Science student with a focus on real-time rendering, signed distance fields, and interactive graphics.',
  ...
  bio: [
    ...
    'I am seeking research-oriented internships and graduate study in visual computing, real-time graphics, and physically based and non-photorealistic rendering.',
  ],
}
